...
function EditScreen({ route, navigation }) {
    ...
    const [age, onChangeAgeText] = useState(petData.age);
    const [breed, onChangeBreed] = useState(petData.breed);
    const [image, onChangeImage] = useState(petData.image);
    ...
    return (
        <View style={styles.container}>
            ...
            />
            <Text style={styles.text}>Edit pet</Text>
            <TextInput
                style={styles.input}
                placeholder="Name"
